...
import { SignedIn, environment, json, loginHandlers, stubFetch, type StubHandler } from '../test/harness';
...
function LogoutProbe() {
  ...
  return (
    <div>
      <button type="button" onClick={() => auth.logout().catch((error: Error) => setMessage(error.message))}>
        Attempt sign-out
      </button>
