...
import type { HealthCondition, HealthView } from '../api/types';
...
function healthView(): HealthView {
  const conditions: HealthCondition[] = conditionTypes.map((type, index) => ({
    ...
    source_device_id: '018f1f7e-6d31-7cc5-8db8-17547f78e6c2',
    last_transition_time: '2026-08-29T12:00:00Z',
  }));
  return {
    aggregate: { status: 'False', blocking_type: 'edge_connected', reason: 'channel_disconnected', blocking_device_id: conditions[0].source_device_id },
    conditions,
